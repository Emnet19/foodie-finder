...
const Footer = () => {
    ...
    <div className="flex items-center">
        ...
        <a href="#"><img src="/src/assets/image/facebook.png" alt="Facebook" className="w-6 h-6 mr-2" /></a>
    </div>
    <div className="flex items-center">
        
        <a href="#"><img src="/src/assets/image/twitter.png" alt="Twitter" className="w-6 h-6 mr-2" /></a>
    </div>
    <div className="flex items-center">
      
        <a href="#"><img src="/src/assets/image/instagram.jpg" alt="Instagram" className="w-6 h-6 mr-2" /></a>
    </div>
    <div className="flex items-center">
        
        <a href="#"><img src="/src/assets/image/pinterest.png" alt="Pinterest" className="w-6 h-6 mr-2" /></a>
    </div>
</div>
                </div>
